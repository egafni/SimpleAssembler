...
O(|Fragments|^2 * |Fragment Length|) since the worst case scenario is each fragment is compared to all remaining fragments, and
each fragment comparison is dependent on the fragment length.  My primary
